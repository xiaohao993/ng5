...
module.exports = "<p>\n  about works!\n  <a href=\"javascript:void(0);\" (cilck)=\"sendMeHome()\"></a>\n  Take me back\n</p>\n<ul>\n\t<li *ngFor=\"let goal of goals\">\n\t\t{{goal}}\n\t</li>\n</ul>"
...
module.exports = "<!--The content below is only a placeholder and can be replaced.-->\n<ul>\n  <li><a routerLink=\"\">Home</a></li>\n  <li><a routerLink=\"about/6\">About</a></li>\n</ul>\n<router-outlet></router-outlet>\n"
...
var DataService = /** @class */ (function () {
    function DataService() {
        this.goals = new __WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject__["a" /* BehaviorSubject */](['The initial goal', 'B']);
